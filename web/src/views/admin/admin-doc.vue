  ...
  >
    <a-form :model="docItem">
      ...
      <a-form-item label="父分类">
        <a-select v-model:value="docItem.parent" placeholder="please select your zone">
          <a-select-option value="0">无</a-select-option>
          <a-select-option v-for="c in level1" :key="c.id" :value="c.id" :disabled="docItem.id === c.id">{{c.name}}</a-select-option>
        </a-select>
      </a-form-item>
